...
export const JOURNAL: JournalEntry[] = [
  {
    date: '2026.09.13',
    items: [
      { type: 'new', target: '入库消化', note: '36 周消化批入账（47 篇 + 体系记忆周报）：重大回测闭环 1 条（美联储路径——6.19"9 月加息"预警方向命中，"不会加息"与"可能降息"两版证伪）、方向命中 3 条（黄金 4400、宇树后果链、机器人有业绩）、冲突加剧 1 条（光模块投行上调 vs 天花板）、新增 L4 候选 1 条（L4-C10 循环融资结构风险）。落地：NOW +8 条、命题注记 +7 处；7 项待裁决另交本人。' },
      ...
      { type: 'risk', target: '存储', note: '利润率 76%–82% 历史极值 vs 铠侠第一句"涨够了"与客户预算抵制——登记"紧缺延续 ≠ 价格斜率延续"。命题六距证伪条件（盈利预测不降反升）进入最近值守距离；不改概率，分歧登记方式待本人裁决。', thesisId: 'memory-cycle' },
