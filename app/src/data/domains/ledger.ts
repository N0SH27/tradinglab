...
export const LEDGER: Revision[] = [
  {
    ...
    previous: 51,
    current: 46,
    reason: '宇树上市首日情绪定价崩溃被核实：开盘 +629%、峰值市值 4449 亿，第 11 个交易日腰斩至 2226 亿。"上市即泡沫崩溃"判断经 2026.09.04 裁决暂时成立——首日情绪定价被证伪，发行价口径仍 +265%，解禁与业绩期再验。',
    evidence: [
      '宇树 8.19 上市开盘 1100 元（+629%），峰值市值 4449 亿（2026.08.19）',
      '9.3 收 550.45 元、市值 2226 亿，较峰值 -50%；流通盘仅 7.44%（2026.09.03 核实）',
    ],
    note: '下调概率 51% → 46%（暂置值，待本人校准）。首日情绪定价的崩溃不改变供应链降本事实，但确认了"估值透支速度快于产业兑现"的下行风险。',
  },
  {
